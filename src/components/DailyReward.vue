<template>
  <q-dialog :value="show" persistent transition-show="scale" transition-hide="scale">
    <q-card bordered class="my-card">
        ...
        <q-list bordered separator>
          <q-item>
            <q-item-section style="max-width: 120px">
              <q-select label="Rewards Type" stack-label v-model="model.type"
      ...
      <q-card-actions align="right">
        ...
        <q-btn @click="submit" flat>
          Submit
        </q-btn>
        <q-btn @click="cancel" flat>
          Cancel
        </q-btn>
      </q-card-actions>
    </q-card>
