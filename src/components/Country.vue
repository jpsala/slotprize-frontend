  ...
  >
    ...
    >
      <div class="row">
        <div class="text-h6">
          <q-input
            v-model="countryCopy.name"
            label="Name"
          />
          <div class="row">
            <q-input
              class="col"
              v-model="countryCopy.currency"
              label="Currency"
            />
            <q-input
              class="col"
              v-model="countryCopy.phonePrefix"
              label="Phone Prefix"
            />
          </div>
          <!-- <pre>{{languages}}</pre> -->
          <q-select
            ...
            map-options
            stack-label
            v-model="countryCopy.languageId"
            :options="languages"
            option-value="id"
          ...
          <img
            ...
            id="output_image"
            :src="countryCopy.textureUrl ? countryCopy.textureUrl : missingImage"
          >
        </div>
      </div>
    </q-card-section>
