<template>
  <div class="q-pa-md q-gutter-md justify-center">
    ...
    <q-markup-table wrap-cells>
      <thead>
        <tr>
          <th class="text-left td-check">
            <q-checkbox
              @input="toggleCheckAll"
              :value="checkedAll"
            />
          </th>
          <th class="text-left td-date">
            Date
          </th>
          <!-- <th class="text-left td-description">Description</th> -->
          <th class="text-left td-description">
            Prize
          </th>
          <th class="text-left">
            Origin
      ...
      <tbody>
        ...
        >
          ...
          <td class="text-left">
            <router-link :to="{ path: '/player', query: { player: item.userId } }">
              {{ item.user }}
            </router-link> | {{ item.email }}
          </td>
        </tr>
      </tbody>
    </q-markup-table>
